  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gray-200/80 text-gray-600 hover:bg-gray-300/80 transition-colors text-xs font-semibold"
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-72 bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/30 p-4 z-50">
